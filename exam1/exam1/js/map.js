...
function getFrank(){
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            const rateCAD = data.rates.CAD;
            const rateCNY = data.rates.CNY;


            const frankDiv = document.getElementById("frank");
                frankDiv.innerHTML = `
                <p><b>On</b> ${date}</p>
                <p><b>Price:</b> ${amount} ${base} can be ${rateAUD} AUD</p>
                <p><b>Price:</b> ${amount} ${base} can be ${rateBGN} AUD</p>
                <p><b>Price:</b> ${amount} ${base} can be ${rateBRL} AUD</p>
                <p><b>Price:</b> ${amount} ${base} can be ${rateCAD} AUD</p>
                <p><b>Price:</b> ${amount} ${base} can be ${rateCNY} AUD</p>
